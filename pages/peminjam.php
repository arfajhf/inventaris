                  ...
                  <div class="table-responsive p-0">
                    <table class="table align-items-center mb-0">
                      <thead>
                        ...
                        if (isset($_POST['cari'])) {
                          $cari = $_POST['cari'];
                          $query = mysqli_query($conn, "select * from peminjaman where nama_petugas like '%" . $cari . "%'");
                        } else {
                        ...
                        <tr>
                          ...
                          <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Nama Peminjaman</th>
                      ...
                      <tbody>
                        ...
                        while ($coba = mysqli_fetch_array($query)) {
                          ...
                          echo "<td class='text-center'>" . $coba['kode_pinjam'] . "</td>";
                          echo "<td class='text-center'>" . $coba['id_pegawai'] . "</td>";
                          echo "<td class='text-center'>" . $coba['jumlah_pinjam'] . "</td>";
                          echo "<td class='text-center'>" . $coba['status_pinjam'] . "</td>";
                          echo "<td class='text-center'>" . $coba['tanggal_pinjam'] . "</td>";
                          echo "<td class='text-center'>" . $coba['tanggal_kembali'] . "</td>";
                          echo "<td>";
                        ?>
                          <div class='text-center'>
                            <button class="btn btn-info text-center mx-0 viewpetugas"><i class='fas fa-eye'></i></button>
