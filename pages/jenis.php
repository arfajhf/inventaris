        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">Jenis</h6>
                </nav>
                <style>
                    .cari {
                        display: block;
                    ...
                    <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                        <form action="jenis.php" method="post">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control mx-0" name="cari" placeholder="Cari Jenis...">
                ...
                <div class="container-fluid py-4">
                    <div class="row">
                        <div class=" align-items-center ">
                            <?php
                            $ambilj = "SELECT * from jenis";
                            $queryj = mysqli_query($conn, $ambilj);
                            $hitungj = mysqli_num_rows($queryj);
                            ?>
                            <p class="btn btn-info btn-sm mb-3">Jenis Yang Tersedia Ada <?= $hitungj; ?> jenis</p>
                        </div>
                        <div class="d-flex align-items-center justify-content-between">
                            <button type="button" id="btnbtn" class="btn btn-info btn-sm mb-3" data-bs-target="#mymodal" data-bs-toggle="modal">Tambah Jenis</button>
                        </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="../controller/jenisController.php" method="post">
                                            <input type="text" class="form-control mb-1" name="j_nama" placeholder="Masukan Nama Jenis">
                                            <input type="text" class="form-control mb-1" name="j_kode" placeholder="Masukan Kode Jenis">
                                            <input type="text" class="form-control mb-1" name="j_ket" placeholder="Masukan Keterangan">
                                    </div>
                                    ...
                                    <div class="table-responsive p-0">
                                        <table class="table align-items-center mb-0">
                                            <thead>
                                                ...
                                                if (isset($_POST['cari'])) {
                                                    $cari = $_POST['cari'];
                                                    $query = mysqli_query($conn, "select * from jenis where nama_jenis like '%" . $cari . "%'");
                                                } else {
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Kode Jenis</th>
                                                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Nama Jenis</th>
                                            ...
                                            <tbody>
                                                ...
                                                while ($coba = mysqli_fetch_array($query)) {
                                                    echo "<tr>";
                                                    echo "<td>" . $no++ . "</td>";
                                                    echo "<td>" . $coba['kode_jenis'] . "</td>";
                                                    echo "<td class='text-center'>" . $coba['nama_jenis'] . "</td>";
                                                    echo "<td>";
                                                ?>
                                                    <div class='text-center'>
                                                        <button class="btn btn-info text-center mx-0 viewjenis" data-id="<?= $coba['id_jenis']; ?>" data-nama="<?= $coba['nama_jenis'] ?>" data-kode="<?= $coba['kode_jenis']; ?>" data-ket="<?= $coba['keterangan']; ?>""
                                                        >
                                                         <i class='far fa-eye'></i>
                                                        </button>
                                                        <button class=" btn btn-success text-center mx-0 editjenis" data-id="<?= $coba['id_jenis']; ?>" data-nama="<?= $coba['nama_jenis'] ?>" data-kode="<?= $coba['kode_jenis']; ?>" data-ket="<?= $coba['keterangan']; ?>""
                                                        >
                                                         <i class='far fa-edit'></i>
                                                        </button>
                                                        <a href='../controller/deletejController.php?id=<?php echo $coba['id_jenis']; ?>' class='btn btn-danger mx-1'><i class='fas fa-trash'></i></a>
                    ...
                    <div class=" modal" id="myedit">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <!-- body modal -->
                                                                    <div class="modal-body">
                                                                        <form action="../controller/editjController.php" method="post">
                                                    ...
                                                    <div class="modal" id="myview">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form action="../controller/editjController.php" method="post">
                                                                        <input type="hidden" class="form-control mb-1" name="idj" disabled>
                                                                        <input type="text" class="form-control mb-1" name="namaj" disabled>
                                                                        <input type="text" class="form-control mb-1" name="kodej" disabled>
                                                                        <textarea name="ketj" class="form-control mb-1" disabled></textarea>
                                                                </div>
